    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e5dec9] dark:border-[#2d3239] pb-4">
        ...
        <Link
          ...
          className="px-4 py-2.5 rounded-xl bg-[#2d6a4f] text-[#f7f1e3] text-xs font-bold hover:bg-[#1b4332] shadow-xs"
        >
      ...
      <div className="space-y-4">
        {deliveries.map((del) => (
          <div
            key={del.id}
            className="p-6 rounded-3xl bg-white dark:bg-[#1c2024] border-2 border-[#e5dec9] dark:border-[#2d3239] hover:border-[#2d6a4f] shadow-xs hover:shadow-md transition-all space-y-4"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#e5dec9]/60 pb-3">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-[#5c6068]">
              ...
              <div className="flex items-center gap-2.5 shrink-0">
                ...
                {del.status === 'IN_TRANSIT' && (
                  <Link
                    ...
                    className="px-4 py-2.5 rounded-xl bg-[#2d6a4f] hover:bg-[#1b4332] text-[#f7f1e3] text-xs font-bold shadow-xs transition-colors"
                  >
