  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-6 rounded-3xl bg-white dark:bg-[#1c2024] border border-[#e5dec9] dark:border-[#2d3239] shadow-xs space-y-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-[#5c6068]">
            TOTAL FOOD RECEIVED
          </span>
          <div className="text-3xl font-heading font-black text-[#2d6a4f]">
      ...
      <div className="bg-white dark:bg-[#1c2024] rounded-3xl border border-[#e5dec9] dark:border-[#2d3239] shadow-xs p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-5 rounded-2xl bg-[#fdfbf7] dark:bg-[#14171a] border border-[#e5dec9] space-y-2">
            <div className="flex items-center justify-between text-xs font-bold text-[#5c6068]">
              <span>CO2e Prevented (Est.)</span>
              <Wind className="w-4 h-4 text-emerald-600" />
            </div>
            <div className="text-2xl font-heading font-black text-[#2d6a4f]">
          ...
          <div className="p-5 rounded-2xl bg-[#fdfbf7] dark:bg-[#14171a] border border-[#e5dec9] space-y-2">
            ...
            <div className="text-2xl font-heading font-black text-blue-700 dark:text-blue-400">
          ...
          <div className="p-5 rounded-2xl bg-[#fdfbf7] dark:bg-[#14171a] border border-[#e5dec9] space-y-2">
            ...
            <div className="text-2xl font-heading font-black text-amber-700 dark:text-amber-400">
        ...
        <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-zinc-800/40 border border-[#e5dec9] text-[11px] text-[#5c6068] flex items-center gap-2">
          <Info className="w-4 h-4 text-[#5c6068] shrink-0" />
          <span>
