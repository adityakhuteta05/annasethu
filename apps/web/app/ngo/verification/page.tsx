...
export default function NGOVerificationStatusPage() {
  ...
  return (
    <main className="min-h-screen p-4 sm:p-6 lg:p-8 bg-white dark:bg-[#121417]">
      {/* Header */}
      <header className="max-w-4xl w-full mx-auto flex items-center justify-between pb-4 border-b border-slate-200 border-slate-200">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-[#2d6a4f] text-white flex items-center justify-center font-semibold tracking-tight text-lg font-bold">
            अ
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-500 hover:bg-white"
          >
          ...
          <Link
            href="/ngo/dashboard"
            className="px-3.5 py-1.5 rounded-xl bg-[#2d6a4f] text-white text-xs font-bold hover:bg-emerald-700"
          >
      ...
      <div className="max-w-3xl w-full mx-auto py-8 space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 border-slate-200 shadow-md p-6 sm:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 border-slate-200 pb-6">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Application Reference: <span className="font-mono font-bold text-slate-900">VER-NGO-2026-88412</span>
              </p>
            </div>
          ...
          {/* Desk Notes */}
          <div className="p-4 rounded-2xl bg-slate-50 bg-white border border-slate-200 border-slate-200 space-y-2">
          ...
          {/* Action CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-slate-200 border-slate-200">
            <Link
              href="/ngo/profile"
            ...
            <Link
              href="/ngo/dashboard"
              className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold text-center shadow-xs"
            >
