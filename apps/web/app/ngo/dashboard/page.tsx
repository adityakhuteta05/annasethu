...
export default function NGODashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs">
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 font-sans">
            Operations Console: <span className="font-bold text-emerald-700">"What do we need today?"</span>
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            disabled={refreshing}
            className="p-2.5 rounded-xl border border-slate-200 border-slate-200 text-slate-500 hover:text-emerald-700 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
          ...
          <Link
            ...
            className="px-4 py-2.5 rounded-xl border-2 border-emerald-600 text-emerald-700 font-bold text-xs flex items-center gap-2 hover:bg-emerald-600/10 transition-colors"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-bold tracking-tight text-emerald-700 dark:text-[#4f9d3a]">
        ...
        <div className="col-span-2 lg:col-span-1 p-4 sm:p-5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/20 border-2 border-emerald-200 dark:border-emerald-900/30 shadow-xs">
          ...
          <Link
            href="/ngo/capacity"
            className="text-[11px] text-emerald-700 font-bold underline mt-1 block"
          >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 border-slate-200 shadow-xs p-6 sm:p-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 border-slate-200 pb-4">
          <div>
          ...
          {(d.todays_needs || []).map((need: any) => {
            ...
            return (
              <div
                ...
                className="rounded-2xl border border-slate-200 border-slate-200 bg-white p-5 space-y-4 relative overflow-hidden"
              >
                {/* Meal Header */}
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-1 rounded-lg bg-emerald-600/10 text-emerald-700 text-xs font-bold tracking-wider">
                    {need.meal_period}
                  </span>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between text-[11px] text-slate-500">
                    <span>Remaining: <strong className="text-slate-900 dark:text-white">{need.remaining_quantity} kg</strong></span>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 border-slate-200 shadow-xs p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {(d.nearby_opportunities || []).map((opp: any) => (
            <div
              key={opp.id}
              className="p-5 rounded-2xl border-2 border-slate-200 border-slate-200 hover:border-emerald-600 bg-white shadow-xs hover:shadow-md transition-all space-y-4"
            >
              <div className="flex items-start justify-between">
                ...
                <div className="px-3 py-1 rounded-xl bg-emerald-600/15 text-emerald-700 border border-emerald-600/30 text-center shrink-0">
              ...
              <div className="grid grid-cols-3 gap-2 p-3 rounded-xl bg-white border border-slate-200 border-slate-200 text-xs">
                <div>
                  <span className="text-[10px] text-slate-500 block">Distance</span>
                  <strong className="text-slate-900 dark:text-white">{opp.distance_km} km</strong>
                </div>
                <div>
                  <span className="text-[10px] text-slate-500 block">ETA</span>
                  <strong className="text-slate-900 dark:text-white">{opp.eta_minutes} min</strong>
                </div>
                <div>
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <Link
                  href="/ngo/available-food"
                  className="px-3 py-2.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-500 hover:bg-white"
                >
                  Why This Match?
                </Link>
              </div>
