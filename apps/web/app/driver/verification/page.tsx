    ...
    <main className="min-h-screen p-4 sm:p-6 lg:p-8 bg-white dark:bg-[#121417]">
      ...
      <header className="max-w-3xl w-full mx-auto flex items-center justify-between pb-4 border-b border-slate-200 border-slate-200">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-[#e0662b] text-white flex items-center justify-center font-semibold tracking-tight text-lg font-bold">
            अ
          </div>
          <div>
      ...
      <div className="max-w-3xl w-full mx-auto py-6 space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 border-slate-200 shadow-md p-6 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="p-3 rounded-2xl bg-slate-50 bg-white border border-slate-200 border-slate-200 text-center">
              <div className="text-xs font-bold text-slate-900 dark:text-[#4f9d3a]">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 border-slate-200 shadow-md p-6 space-y-4">
          ...
          <div className="space-y-3">
            {complianceItems.map((item) => (
              <div
                key={item.id}
                className="p-4 rounded-2xl border border-slate-200 border-slate-200 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-3"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    type="button"
                    className="px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-500 hover:bg-white"
                  >
                    View File
                  </button>
