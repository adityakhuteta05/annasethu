...
export default function AdminDashboardPage() {
  ...
  return (
    <main className="min-h-screen p-6 sm:p-10 max-w-5xl mx-auto space-y-6">
      <header className="flex items-center justify-between border-b border-[#e5dec9] pb-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-[#e5dec9] text-xs font-semibold text-[#5c6068] hover:bg-gray-100"
        >
      ...
      <div className="p-8 rounded-3xl bg-white dark:bg-[#1c2024] border border-[#e5dec9] dark:border-[#2d3239] shadow-xs text-center space-y-3">
        ...
        <p className="text-xs text-[#5c6068] max-w-md mx-auto">
        ...
        <div className="pt-4 flex items-center justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#1f4d36] text-white text-xs font-bold shadow-sm hover:bg-[#163827] transition-all"
          >
