          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl transition-all whitespace-nowrap ${
                activeTab === t.id
                  ? 'bg-[#1f4d36] text-white font-bold shadow-xs'
      ...
      {activeTab === 'business' && (
        <div className="bg-white dark:bg-[#1c2024] p-6 rounded-3xl border border-[#e5dec9] dark:border-[#2d3239] shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              <label className="font-bold text-[#23262b] dark:text-[#f7f1e3] block mb-1">
                Legal Entity Name
              </label>
              <input
                type="text"
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-[#e5dec9] dark:border-[#2d3239] bg-transparent text-xs"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                disabled
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-xs text-[#5c6068]"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-[#e5dec9] dark:border-[#2d3239] bg-transparent text-xs font-mono"
              />
            </div>
          ...
          <div className="pt-2">
            <button
              onClick={handleSave}
              className="px-6 py-2.5 rounded-xl bg-[#1f4d36] text-white text-xs font-bold hover:bg-[#163827]"
            >
        ...
        <div className="bg-white dark:bg-[#1c2024] p-6 rounded-3xl border border-[#e5dec9] dark:border-[#2d3239] shadow-xs space-y-4">
          <div className="flex items-center justify-between border-b border-[#e5dec9] pb-3">
            <div>
              ...
              <span className="text-xs text-[#5c6068]">Food safety and GST compliance logs</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 space-y-1">
              <span className="text-[#5c6068]">GSTIN (Goods and Services Tax):</span>
              <p className="font-mono font-bold text-sm text-[#1f4d36] dark:text-[#4f9d3a]">{businessData.gstin}</p>
            ...
            <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 space-y-1">
              ...
              <p className="font-mono font-bold text-sm text-[#1f4d36] dark:text-[#4f9d3a]">{businessData.fssai}</p>
      ...
      {activeTab === 'locations' && (
        <div className="bg-white dark:bg-[#1c2024] p-6 rounded-3xl border border-[#e5dec9] dark:border-[#2d3239] shadow-xs space-y-4">
          <div className="flex items-center justify-between border-b border-[#e5dec9] pb-3">
            ...
            <button className="px-3 py-1.5 rounded-xl bg-[#1f4d36] text-white text-xs font-bold flex items-center gap-1">
          ...
          <div className="p-4 rounded-2xl border border-gray-100 dark:border-gray-800 flex justify-between items-center text-xs">
            <div>
              ...
              <span className="text-[#5c6068]">Dr Zakir Hussain Marg, New Delhi · GPS: 28.5996, 77.2373</span>
            </div>
