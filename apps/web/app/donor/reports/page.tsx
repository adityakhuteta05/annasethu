    ...
    <div className="space-y-6 pb-16">
      ...
      <div className="space-y-4">
        {reportsList.map((r) => (
          <div
            key={r.id}
            className="p-6 rounded-3xl bg-white dark:bg-[#1c2024] border border-[#e5dec9] dark:border-[#2d3239] shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-[#1f4d36] transition-all"
          >
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-4 text-xs text-[#5c6068] pt-1">
                <span>Period: {r.period}</span>
                <span>•</span>
                <span>{r.missions} verified deliveries</span>
                <span>•</span>
                <span className="font-bold text-[#1f4d36] dark:text-[#4f9d3a]">{r.rescued_kg} kg rescued</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className="px-4 py-2 rounded-xl border border-[#1f4d36] text-[#1f4d36] dark:text-[#4f9d3a] text-xs font-bold hover:bg-[#1f4d36] hover:text-white transition-all flex items-center gap-1.5"
              >
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#1f4d36] hover:bg-[#163827] text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-xs"
              >
      ...
      {selectedReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-white dark:bg-[#1c2024] max-w-2xl w-full rounded-3xl p-8 border border-[#e5dec9] dark:border-[#2d3239] shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between border-b border-[#e5dec9] pb-4">
              ...
              <button
                ...
                className="text-xs text-[#5c6068] hover:text-[#23262b] p-1"
              >
                ✕ Close
              </button>
            </div>
            ...
            <div className="space-y-4 text-xs">
              <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 space-y-2">
                <div className="flex justify-between">
                  <span className="text-[#5c6068]">Issuing Authority:</span>
                  <span className="font-bold text-[#1f4d36] dark:text-[#4f9d3a]">AnnaSetu Verified Impact Architecture</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#5c6068]">Donor Entity:</span>
                  <span className="font-semibold text-[#23262b] dark:text-[#f7f1e3]">The Oberoi Grand Kitchens</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#5c6068]">GSTIN Reference:</span>
                  <span className="font-mono">07AAACC1206D1Z1</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#5c6068]">FSSAI Clearance:</span>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center">
                  <span className="text-[#5c6068] block">Weight Rescued</span>
                  <span className="text-base font-bold text-[#1f4d36] dark:text-[#4f9d3a]">{selectedReport.rescued_kg} kg</span>
                </div>
                <div className="p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center">
                  <span className="text-[#5c6068] block">Meals Equivalent</span>
                  <span className="text-base font-bold text-[#e0662b]">{selectedReport.meals}</span>
                </div>
                <div className="p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center">
                  <span className="text-[#5c6068] block">CO₂e Avoided</span>
                  <span className="text-base font-bold text-emerald-700">{selectedReport.co2e} kg</span>
                </div>
              </div>

              <p className="text-[11px] text-[#5c6068] leading-relaxed pt-2">
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-[#e5dec9]">
              ...
              <button
                onClick={() => window.print()}
                className="px-5 py-2 rounded-xl bg-[#1f4d36] text-white text-xs font-bold flex items-center gap-1.5"
              >
