    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 border-slate-200 pb-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 text-white text-xs font-bold hover:bg-emerald-700 shadow-xs"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        <div className="p-4 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs space-y-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Total Food Rescued</span>
          <div className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
            {factual.total_food_rescued_kg.toLocaleString()} <span className="text-xs font-normal text-slate-500">kg</span>
          </div>
          <span className="text-[10px] text-emerald-700 font-semibold block">Factual weight ledger</span>
        </div>

        <div className="p-4 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs space-y-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Total Postings</span>
          <div className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
            {factual.total_donations_count}
          </div>
          <span className="text-[10px] text-slate-500 block">Kitchen declarations</span>
        </div>

        <div className="p-4 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs space-y-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Successful Rescues</span>
        ...
        <div className="p-4 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs space-y-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Meal Equivalents</span>
          <div className="text-2xl font-bold tracking-tight text-[#e0662b]">
            {factual.meal_equivalents_supported.toLocaleString()}
          </div>
          <span className="text-[10px] text-slate-500 block">Calculated @ 2 meals/kg</span>
        </div>

        <div className="p-4 rounded-2xl bg-white border border-slate-200 border-slate-200 shadow-xs space-y-1 col-span-2 lg:col-span-1">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Shelters Served</span>
          <div className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
      ...
      <div className="p-6 rounded-3xl bg-linear-to-r from-emerald-50/70 via-white to-teal-50/50 dark:from-[#162118] dark:to-[#1c2024] border border-emerald-200 dark:border-emerald-900/60 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-emerald-100 dark:border-gray-800 pb-3">
          <div>
            <h2 className="text-base font-bold tracking-tight text-slate-900 dark:text-[#4f9d3a] flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-black/30 border border-emerald-100 dark:border-emerald-900/30 space-y-1">
            ...
            <span className="text-[10px] text-slate-500 block">Equivalent to ~12,400 km car driving</span>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-black/30 border border-emerald-100 dark:border-emerald-900/30 space-y-1">
            ...
            <span className="text-[10px] text-slate-500 block">Embedded agricultural water conserved</span>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-black/30 border border-emerald-100 dark:border-emerald-900/30 space-y-1">
            ...
            <span className="text-[10px] text-slate-500 block">Anaerobic decomposition avoided</span>
          </div>
        </div>
            ...
            {[
              ...
              <div key={m.month} className="space-y-1">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-bold text-slate-900 dark:text-[#4f9d3a]">{m.kg} kg ({m.meals} meals)</span>
                </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 border-slate-200 shadow-xs space-y-4">
          ...
          <div className="space-y-3 pt-2">
            {[
              ...
              { category: 'Grains & Rice/Biryani', kg: 350, pct: 28, color: 'bg-emerald-600' },
              ...
              <div key={cat.category} className="space-y-1">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-semibold text-slate-500">{cat.kg} kg ({cat.pct}%)</span>
                </div>
                <div className="h-2 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                  <div
